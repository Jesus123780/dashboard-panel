        ...
        <>
            ...
            <SliderContainer modal={modal} >
                ...
                <div>
                    ...
                    <ControlRight onClick={() => state?.currentIndex < dataCategories?.length - 1 ? dispatch({ type: 'NEXT' }) : dispatch({ type: 'RESET' })}><IconArrowRight color={PColor} size={'20px'} /></ControlRight>
                </div>
            </SliderContainer>
        </>
    );
